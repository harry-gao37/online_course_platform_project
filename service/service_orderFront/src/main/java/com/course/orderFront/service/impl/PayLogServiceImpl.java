...
import com.course.model.order.PayLog;
import com.course.orderFront.mapper.PayLogMapper;
import com.course.orderFront.service.OrderService;
import com.course.orderFront.service.PayLogService;
import com.course.orderFront.utils.HttpClient;
...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public Map<String, Object> createWxNativePay(String orderNo) {
        ...
        try {
            ...
            e.printStackTrace();
            throw CourseException.from(ResultCode.WXPAY_FAIL);
        }
    }
