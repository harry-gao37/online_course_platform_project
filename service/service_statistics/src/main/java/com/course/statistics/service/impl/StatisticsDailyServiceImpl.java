package com.course.statistics.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.course.client.UcenterFeignClient;
import com.course.model.statistics.StatisticsDaily;
import com.course.statistics.mapper.StatisticsDailyMapper;
...
public class StatisticsDailyServiceImpl extends ServiceImpl<StatisticsDailyMapper, StatisticsDaily> implements StatisticsDailyService {
    ...
    public void countRegister(String day) {
        ...
        //远程调用得到某一天的注册人数
        Integer countRegister = ucenterFeignClient.countRegister(day);
